 ...
 */
print("this code compiles because it is a variable. this is different than trying to update a constant because in a variable you can change it to another variable in the compatible type." )
