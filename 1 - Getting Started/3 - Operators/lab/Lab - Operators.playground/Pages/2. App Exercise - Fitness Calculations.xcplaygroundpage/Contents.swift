 ...
 */
let heartRate1D = 89.00
let heartRate2D = 63.00
let heartRate3D = 100.00
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print("averageHRD = 84")
print("this doesnt differ because 3 goes into the added sum perfectly")
