 ...
 */
let favoriteQuote = String("My favorite quote is <The difference between stupidity and genius is that genius has its limits.>")
print(""My favorite quote is <The difference between stupidity and genius is that genius has its limits.>"")
/*:
